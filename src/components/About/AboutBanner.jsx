                ...
                <div id="content-Row">
                    ...
                    <section className='w-full md:h-[620px] h-[300px] bg-cover bg-center bg-no-repeat rounded-[12px] relative' data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-delay="1000" style={{backgroundImage: `linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.4)), url(${aboutBg})`}}>
                        ...
                        <div className='md:pt-[45px] pt-4 md:pl-[44px] pl-4'>
                            <h2 className='md:text-[40px] text-xl font-bold text-white'>Akintos Atlas Limited</h2>
                            <p className='text-white'>Multidisciplinary building consultancy — engineering design, energy & sustainability advisory, and project delivery support.</p>
                        </div>
                        ...
                        {/* -------------- Texts -------------- */}
                            ...
                            <p className='text-white md:text-base text-xs'>We support clients with building engineering, energy modelling, retrofit strategies, and smart building integration — delivering data-driven, practical solutions that reduce environmental impact and raise building performance.</p>
                        </div>
                    </section>
                    {/* ----------------------------- Counter ----------------------------- */}
