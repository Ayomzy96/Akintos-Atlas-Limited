            ...
            <div className="container">
                <div id="Personalized-Row"  className='flex items-center justify-between flex-wrap gap-y-10 md:flex-row flex-col-reverse'>
                    ...
                    <div className='md:w-[526px]'>
                        <h2 className='md:text-[40px] text-xl text-headText font-bold md:leading-[50px] md:mb-10 mb-4' data-aos="fade-up">Tailored consultancy for your projects</h2>
                        <h2 className='md:text-base text-sm text-black font-base leading-[20px] md:mb-10 mb-6' data-aos="fade-up">Whether you are planning a new development or upgrading an existing building, we provide bespoke consultancy — energy audits, retrofit strategies, MEP design, and digital building analytics to improve performance and resilience.</h2>
                        <Link to={'/contact'} className='text-primary md:text-base text-sm bg-[#0057FF] md:w-[200px] w-fit md:px-0 px-6 text-center md:py-4 py-3 rounded-[6px] cursor-pointer hover:bg-brand hover:text-primary duration-300 flex items-center gap-3 justify-center' data-aos="fade-up">Get in touch <IoIosTrendingUp className='text-xl' /></Link>
                    </div>
