            ...
            <div className="container">
                <div id="Footer-Row" className='flex flex-wrap md:gap-0 gap-15  items-start justify-between'>
                    ...
                    <div>
                        ...
                        <ul className='text-primary text-base flex flex-col gap-4 mt-6 opacity-[.8]'>
                            <li data-aos="fade-up"><Link id='HoverLinks' to={'/'}>(Lagos): 17 Oluwole oladejo, Ojodu, Berger <br /> (England): 14 granville Road ME12 1QL </Link></li>
                            <li data-aos="fade-up"><Link id='HoverLinks' to={'/'}>+234 909 671 0315 <br />+4407459478486</Link></li>
                            <li data-aos="fade-up"><Link id='HoverLinks' to={'/'}>tosinakinrinde@akintosatlas.com</Link></li>
                        </ul>
                    </div>
                    {/* ---------------------Services Row------------------------- */}
                    <div>
                        <h2 className='font-roboto font-semibold text-xl text-white' data-aos="fade-up">Services</h2>
                        <ul className='text-primary text-base flex flex-col gap-4 mt-6 opacity-[.8]'>
                            <li data-aos="fade-up"><Link id='HoverLinks' to={'/services'}>Energy & Environmental Consulting</Link></li>
                            <li data-aos="fade-up"><Link id='HoverLinks' to={'/services'}>Building Engineering Design (MEP)</Link></li>
                            <li data-aos="fade-up"><Link id='HoverLinks' to={'/services'}>Retrofit & Building Upgrades</Link></li>
                            <li data-aos="fade-up"><Link id='HoverLinks' to={'/services'}>Project Management</Link></li>
                        </ul>
                    </div>
                    {/* ---------------------Third Row------------------------- */}
                    <div>
                ...
                <div id='Footer-Second-row' className='border-t border-white mt-[60px] pt-[30px] pb-[60px] flex flex-wrap md:gap-0 gap-10 items-center justify-between'>
                    <div>
                        ...
                        <p className='font-dmSans md:text-base text-primary md:mt-[16px] mt-3' data-aos="fade-up" data-aos-offset="20">© Developed by <Link className='underline underline-offset-3' to={'https://my-portfolio-website-kappa-taupe.vercel.app/'}>Olaleye Ayomide</Link></p>
                    </div>
                    <div>
                        <h2 className='font-roboto font-semibold md:text-lg text-primary' data-aos="fade-up" data-aos-offset="20">Contact Us</h2>
                        <p className='font-dmSans md:text-base text-primary md:mt-[16px] mt-3' data-aos="fade-up" data-aos-offset="20">tosinakinrinde@akintosatlas.com</p>
                    </div>
