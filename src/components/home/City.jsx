                        ...
                        <section className='mt-8 sm:mt-12 md:mt-16 flex flex-col lg:flex-row items-center gap-6 px-4 md:px-6 lg:px-0'>
                            ...
                            <div className='flex flex-col gap-6 w-full lg:w-auto'>
                                <div className='flex flex-col sm:flex-row items-center gap-6 w-full'>
                                    <Link to={'/projects'} className='relative rounded-[12px] cursor-pointer group overflow-hidden duration-300 w-full' data-aos="fade-up">
                                        ...
                                        <article className="absolute bottom-5 left-4 transform-gpu transition-all duration-700 ease-in-out group-hover:bottom-1/2 group-hover:left-1/2 group-hover:-translate-x-1/2 group-hover:translate-y-1/2">
                                            ...
                                            <p className='text-white text-sm sm:text-base'>28 projects</p>
                                        </article>
                                    </Link>
                                    <Link to={'/projects'} className='relative rounded-[12px] cursor-pointer group overflow-hidden w-full sm:w-1/2' data-aos="fade-up">
                                        ...
                                        <article className="absolute bottom-5 left-4 transform-gpu transition-all duration-700 ease-in-out group-hover:bottom-1/2 group-hover:left-1/2 group-hover:-translate-x-1/2 group-hover:translate-y-1/2">
                                            ...
                                            <p className='text-white text-sm sm:text-base'>6 projects</p>
                                        </article>
                                    </Link>
                                </div>

                                <div className='flex flex-col sm:flex-row items-center gap-6 w-full'>
                                    <Link to={'/projects'} className='relative rounded-[12px] cursor-pointer group overflow-hidden w-full' data-aos="fade-up">
                                        ...
                                        <article className="absolute bottom-5 left-4 transform-gpu transition-all duration-700 ease-in-out group-hover:bottom-1/2 group-hover:left-1/2 group-hover:-translate-x-1/2 group-hover:translate-y-1/2">
                                            ...
                                            <p className='text-white text-sm sm:text-base'>18 projects</p>
                                        </article>
                                    </Link>
                                    <Link to={'/projects'} className='relative rounded-[12px] cursor-pointer group overflow-hidden duration-300 w-full sm:w-1/2' data-aos="fade-up">
                            ...
                            {/* ---------------------- Right Images  */}
                            <Link to={'/projects'} data-aos="fade-up" className='relative w-full sm:w-[306px] h-[300px] sm:h-[545px] rounded-[12px] cursor-pointer group overflow-hidden'>
