...
const FloatingSearch = () => {
    ...
    return (
    <section className='w-[90%] md:w-[95%] lg:w-[1076px] bg-primary px-4 sm:px-6 md:px-10 py-3 relative rounded-b-[12px] md:rounded-tr-[12px] mx-auto lg:translate-y-[-60px] translate-y-0 shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),_0_10px_10px_-5px_rgba(0,0,0,0.04)]' data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-delay="2000" data-aos-offset="20">
            {/* -------------------- Nav select  */}
            <div className='w-full sm:w-[312px] h-[45px] sm:h-[55px] bg-[#F7F7F7] relative lg:absolute lg:top-[-55px] top-0 left-0 flex items-center justify-center rounded-t-[12px]'>
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-2'>
                <div className='w-full sm:w-[255px] p-3 sm:p-4 flex items-center justify-between cursor-pointer rounded-[12px] hover:bg-gray-100 duration-300'>
                    <p className='text-brand text-sm sm:text-base'>Service Category</p>
                    <IoIosArrowDown />
                </div>
                <div className='w-full sm:w-[255px] p-3 sm:p-4 flex items-center justify-between cursor-pointer rounded-[12px] hover:bg-gray-100 duration-300'>
                    <p className='text-brand text-sm sm:text-base'>Service Type</p>
                    <IoIosArrowDown />
                </div>
                <div className='w-full sm:w-[255px] p-3 sm:p-4 flex items-center justify-between cursor-pointer rounded-[12px] hover:bg-gray-100 duration-300'>
                    <p className='text-brand text-sm sm:text-base'>Location / Project</p>
                    <IoIosArrowDown />
                </div>
                <div className='w-full sm:w-[255px] p-3 sm:p-4 flex items-center justify-between rounded-[12px] hover:bg-gray-100 duration-300'>
                    ...
                    <button onClick={()=>window.location.href='/contact'} className='bg-[#0057FF] hover:bg-[#2f74ff] duration-300 rounded-[12px] py-2 sm:py-[15px] px-4 sm:px-[29px] flex items-center gap-2 sm:gap-3 text-primary cursor-pointer text-base sm:text-xl font-medium'>
